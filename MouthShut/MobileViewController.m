...
- (void)viewDidLoad
{
    ...
    searchBar.placeholder = @"Search Mobiles & Tablets";
    ...
    categaoryLabelArray = [[NSArray alloc]initWithObjects:@"Mobiles", @"Tablets", nil];
    
    cellImagesArray = [[NSArray alloc]initWithObjects:[UIImage imageNamed:@"Mobile_cat.png"],[UIImage imageNamed:@"Tablet.png"], nil];
