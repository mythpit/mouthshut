...
@interface MoviesViewController : UIViewController<EDStarRatingProtocol, UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate, UITabBarControllerDelegate, UINavigationControllerDelegate, UITabBarDelegate, UIActionSheetDelegate, UISearchBarDelegate>
{
