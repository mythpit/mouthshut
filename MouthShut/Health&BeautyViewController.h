...
@interface Health_BeautyViewController : UIViewController<EDStarRatingProtocol, UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate, UITabBarControllerDelegate, UINavigationControllerDelegate, UITabBarDelegate, UIActionSheetDelegate>
{
