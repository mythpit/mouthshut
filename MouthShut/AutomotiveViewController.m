...
@interface AutomotiveViewController ()

@end

@implementation AutomotiveViewController
...
- (void)viewDidLoad
{
    ...
    categaoryLabelArray = [[NSArray alloc]initWithObjects:@"Bikes", @"Cars & SUVs", @"Bike Dealers", @"Car Dealers", nil];
    
    cellImagesArray = [[NSArray alloc]initWithObjects:[UIImage imageNamed:@"Bikes.png"],[UIImage imageNamed:@"Cars-and-SUVs.png"],[UIImage imageNamed:@"Bike-Dealers.png"],[UIImage imageNamed:@"Car-Dealers.png"], nil];

    searchBar = [[UISearchBar alloc]initWithFrame:CGRectMake(0, 65, self.view.frame.size.width, 40)];
    searchBar.placeholder = @"Search Automotives";
    ...
    tabbarView.frame = CGRectMake(0, tableCategory.frame.origin.y + tableCategory.frame.size.height, self.view.frame.size.width, 45);
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0 | indexPath.row == 1) {
        product.isLocationBased = NO;
    }else{
        product.isLocationBased = YES;
    }
...
- (IBAction)writeReviewAction:(id)sender {
    WriteReviewViewController *write = [[WriteReviewViewController alloc]initWithNibName:@"WriteReviewViewController" bundle:nil];
