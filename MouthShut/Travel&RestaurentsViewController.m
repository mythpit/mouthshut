//
//  Travel&RestaurentsViewController.m
//  MouthShut
//
...
@interface Travel_RestaurentsViewController ()

@end

@implementation Travel_RestaurentsViewController
...
- (void)viewDidLoad
{
    ...
    categaoryLabelArray = [[NSArray alloc]initWithObjects:@"Restaurants", @"Hotels", @"Travel", nil];
    
    cellImagesArray = [[NSArray alloc]initWithObjects:[UIImage imageNamed:@"Restaurants.png"],[UIImage imageNamed:@"Hotels.png"],[UIImage imageNamed:@"Travel.png"], nil];
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    tableCategory.layer.borderWidth = 0.3;
    tableCategory.layer.borderColor = [[UIColor colorWithRed:178/255.0 green:178/255.0 blue:178/255.0 alpha:0.8] CGColor];
