...
@interface MobileViewController : UIViewController<EDStarRatingProtocol, UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate, UITabBarControllerDelegate, UINavigationControllerDelegate, UITabBarDelegate, UIActionSheetDelegate>
{
