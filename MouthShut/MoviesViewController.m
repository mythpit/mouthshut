...
- (void)viewDidLoad
{
   ...
   // self.edgesForExtendedLayout = UIRectEdgeNone;
    ...
    categaoryLabelArray = [[NSArray alloc]initWithObjects:@"Bollywood", @"Hollywood", @"Regional(Tamil & Telugu)", @"Movie Theatres", nil];
    
    cellImagesArray = [[NSArray alloc]initWithObjects:[UIImage imageNamed:@"Bollywood_cat.png"],[UIImage imageNamed:@"Hollywood_cat.png"],[UIImage imageNamed:@"Regional.png"],[UIImage imageNamed:@"Movie-Theatres_cat.png"], nil];
